...
public class GlobalConstants {
    public static final String SERVER_LINK = "http://demo.nopcommerce.com";
    public static final String TESTING_SERVER = "http://testing.nopcommerce.com";
    public static final String STAGING_SERVER = "http://staging.nopcommerce.com";
